            ...
            {user ? (
              <>
                {!isMobile ? (
                  ...
                  <>
                    <div className="flex items-center gap-2" onClick={() => setIsUserActionsModalOpen(true)}>
                      <span className="flex text-nowrap justify-center gap-x-1.5 rounded-md text-white px-2 py-1 text-[12px] font-light border border-[#636363] hover:border-primary-yellow">
