...
const Footer = () => {
  return (
    <footer className="bg-[#1d1d1d] py-20 sm:py-4 pt-4 border-t border-[#383838]">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="flex flex-col items-center space-y-6 sm:space-y-0 sm:flex-row sm:justify-between">
          <Link to="/home" className="flex items-center space-x-4">
            <img src={logo} alt="Logo" className="w-[3rem] h-[3rem] sm:w-[5rem] sm:h-[4rem] " />
            <h1 className="text-lg sm:text-xl font-bold text-yellow-500">CASHBET</h1>
          </Link>
          <div className="flex flex-row items-center space-x-5 sm:space-x-6 sm:space-y-0 sm:space-x-6">
            <a href="#" className="text-gray-300 hover:text-white transition text-md">
              About
            </a>
            <a href="#" className="text-gray-300 hover:text-white transition text-md">
              Privacy Policy
        ...
        <div className="text-center space-y-2">
          <span className="block text-sm text-gray-500 dark:text-gray-400">Copyright 2024 © CASHBET</span>
        ...
        <div className="pt-6 flex justify-center items-center space-x-6">
          ...
          <div className="flex items-center space-x-4">
            <img src={plus18} alt="plus18" className="w-[2.2rem] h-[2.2rem] filter brightness-0 invert" />
