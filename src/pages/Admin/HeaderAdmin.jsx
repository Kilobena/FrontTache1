...
import BalanceDropDown from "../../components/layout/header/BalanceDropDown";
    ...
    <div className="bg-[#242424] text-white p-1 sm:p-2 shadow-lg flex flex-col w-full mr-4">
      ...
      <div className="text-center mt-6 sm:mt-2 lg:hidden">
        <div className="flex items-center justify-center space-x-3 mt-2">
          ...
          <div className="flex items-center space-x-1 bg-red-600 text-white px-3 py-1 rounded-md hover:bg-red-700 transition" onClick={handleLogout}>
            <FaSignOutAlt className="mr-2 text-lg" />
            <span className="text-md">Logout</span>
          </div>
        </div>
        ...
        <div className="fixed right-0 z-50">
          <button onClick={toggleSidebar} className="sm:hidden text-white text-4xl focus:outline-none mr-3">
