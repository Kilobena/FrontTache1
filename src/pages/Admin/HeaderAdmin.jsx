...
import BalanceDropDown from "../../component/layout/header/BalanceDropDown";
...
const HeaderAdmin = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const tunisTime = new Intl.DateTimeFormat("en-GB", options).format(
    new Date()
  );
    ...
    <div className="bg-[#242424] text-white p-1 sm:p-2 shadow-lg flex flex-col w-full mr-4">
      ...
      <div className="w-full flex flex-col  lg:flex-row items-center justify-between">
        ...
        <a className="flex h-headerLogoHeight">
          <img
            className="h-headerLogoHeight w-56  hidden lg:block"
            src="https://assets.bet24.gg/sites/bet24/Bet24-New%20logo.png"
          />
        </a>
