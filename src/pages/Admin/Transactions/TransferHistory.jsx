...
const TransferHistory = () => {
  ...
  const [selectedSuperAgentOption, setSuperAgentSelectedOption] =
    useState(null);
  ...
  const transfersOptions = [
    { username: "All Transfer", role: "" },
    { username: "Partner", role: "Operator" },
    { username: "Super Agent", role: "Partner" },
    { username: "Agent", role: "Super Agent" },
    { username: "Player", role: "Super Agent" },
  ];
  const trasnfOptions = transfersOptions.map((userOption) => ({
    value: userOption.username,
    label: `${userOption.username}   ${userOption.role}`,
  }));
  console.log(selectedUser, "sss09090");
    ...
    <div className="flex flex-col  w-full trasnfer-history">
      ...
      <div className="flex-1  sm:pt-3">
        <div className="w-full    rounded-lg ">
          {/* Date Filter Section */}
          <div className="mb-8">
            <label className="block font-normal ml-2  text-gray-800 text-lg">
              Transaction Date
            </label>
          ...
          {selectedDate === "custom" && (
            <div className="mb-8">
              ...
              <div className="flex justify-center mt-4 space-x-4">
                <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-11 rounded-lg">
                  CLOSE
                </button>
                <button className="border border-black hover:bg-gray-300 text-gray-700 font-bold py-2 px-11 rounded-lg">
                  CLEAR
                </button>
              </div>
          ...
          <div className="flex flex-col lg:flex-row space-x-0 space-y-2 lg:space-x-2 lg:space-y-0 w-full rtl:space-x-reverse">
            ...
            >
              {selectedUser === "All Transfer" && (
                <>
                  <div className=" w-[48%] sm:w-[0]  lg:w-[48%] 2xl:w-[31%]">
                    <SelectDropDown
                      label="Partner"
                  ...
                  <div className=" w-[48%]    sm:w-[10%] lg:w-[48%] 2xl:w-[31%]">
                    <SelectDropDown
                      label="Super Agent"
                      selectedOption={selectedSuperAgentOption}
                      ref={selectRef}
          ...
          <div className="lg:flex gap-3 mb-8 mt-7">
            <button
              className="bg-yellow-500 hover:bg-yellow-600 p-2  text-black w-full lg:max-w-40 font-bold lg:py-2 px-11 rounded-lg"
              type="button"
          ...
          {errorMessage ? (
            ...
            <>
              ...
              <div className="overflow-x-scroll lg:overflow-x-auto w-full">
                <table className="w-full table-auto agent-table  border border-gray-300 ">
                  ...
                  <tbody className="text-black text-sm items-center">
                    ...
                    <tr>
                      <td className="border text-center border-gray-300 font-bold">
                        asbettest
                      </td>
                      <td className="border text-center border-gray-300">
                        Super Agent
                      </td>
                      <td className="border text-right py-2 px-4 border-gray-300">
                        0.00 TND
                      </td>
                      <td className="border text-right py-2 px-4 border-gray-300">
                        0.00 TND
                  ...
                  <tfoot class="bg-[#808080]  text-white text-sm text-left font-semibold uppercase py-2 px-4">
                    <tr>
                      <th class="text-left py-2 px-4" colspan="2">
                        Total{" "}
                        <span class="lowercase font-normal">(2 Players)</span>
                      </th>
                      <th class="text-right border py-2 px-4 border-gray-300">
                        0.00 TND
                      </th>
                      <th colspan="2"></th>
                    </tr>
              ...
              <div class="tickets-pagination flex flex-wrap mt-6 lg:my-6 items-center flex-col lg:flex-row">
                <div class="text-sm text-[#242424] text-center ltr:lg:text-left rtl:lg:text-right py-2 lg:py-0">
            ...
            <div class="flex flex-col items-center justify-center py-6 px-3 my-7">
              <i
                class="fa fa-search text-slate-600 bg-[#EDEEF5] p-9 rounded-md fa-3x"
                aria-hidden="true"
              ></i>
              <span class="text-lg sm:text-xl mt-8 mb-4 text-[#474747] text-center w-full max-w-[300px]">
                Search all available records by selecting one of the filters
                above!
              </span>
            </div>
          )}
