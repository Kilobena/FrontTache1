          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-0  w-full">
              {dateOptions.map((option, index) => (
                <label
                  key={option.value}
                  className={`flex w-full md:gap-3 lg:max-w-56 items-center ml-0.5  p-2.5  cursor-pointer  ${selectedDate === option.value
              ...
              {selectedUser === "All Transfer" &&
                <>
                  <div className=" w-[48%] sm:w-[0]  lg:w-[48%] 2xl:w-[31%]">
                    <SelectDropDown label="Partner" selectedOption={selectedSuperAgentOption} ref={selectRef} styles={customStyles} options={options} handleChange={handleSuperAgentChange} />
