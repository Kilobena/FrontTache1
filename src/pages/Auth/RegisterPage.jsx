      ...
      <div className="w-full max-w-4xl p-2 pb-5 rounded-lg shadow-lg">
        <div className="w-full">
          <form>
            ...
            <div className="relative">
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pt-2 pl-5">
                  <i className="fa-solid fa-envelope text-black text-lg"></i>
                </span>
            ...
            <div className="mb-4">
              <label for="currency" className="block appearance-none text-[#ababab] border-0 text-md font-medium mb-1">
                Currency
              </label>
              <select id="currency" className="cursor-pointer w-full p-3 text-sm  text-[#1c1c1c]  border-0 rounded-lg   focus:outline-none ">
                <option value="">-- Select Currency --</option>
              </select>
            </div>

            <div className="mb-4">
              <label for="country" className="block text-[#ababab] text-md font-medium mb-1">
                Country
              </label>
              <select id="country" className="cursor-pointer w-full p-3 text-sm  text-[#1c1c1c]  border-0 rounded-lg   focus:outline-none ">
                <option value="">-- Select Country --</option>
              </select>
            </div>

            {/* <div className="mb-4">
              <label for="mobile" className="block text-[#ababab] text-md font-medium mb-1">Mobile Number</label>
              <div className="flex items-center bg-white border border-gray-600  rounded-lg">
                <span className="bg-white text-black pl-3 pr-2">+92</span>
                <input id="mobile" type="text" className="w-full p-2.5  text-sm  text-[#1c1c1c] focus:outline-none focus:ring-0 focus:ring-white" />
              </div>
            </div> */}

            <div className="mb-4">
              <label htmlFor="mobile" className="block text-[#ababab] text-md font-medium mb-1">
                Mobile Number
              </label>
              <div className="flex items-center bg-white border border-gray-600 rounded-lg">
                {/* Dropdown Button */}
                <div className="relative">
                  ...
                  {/* Dropdown Menu */}
                  {isDropdownOpen && (
                    <div id="dropdown-menu" className="absolute p-3 mt-2 bg-[#333333] text-white shadow-lg w-72 z-10 max-h-60 overflow-y-auto">
                      {/* Search Bar */}
                      <input
                        type="text"
                        id="dropdown-search"
                      ...
                      <ul className="">
                        {(filteredCountries.length > 0 ? filteredCountries : countries).map((country) => (
                          ...
                          >
                            <img src={`https://flagcdn.com/w40/${country.flag}.png`} alt={`${country.name} Flag`} className="w-5 h-5 mr-2" />
                            <span className="text-white font-medium text-sm">{`${country.code} ${country.name}`}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="absolute top-2 right-5">
                  <button type="button" className="ml-2 focus:outline-none" onClick={() => setShowPassword(!showPassword)}>
            ...
            <div className="mt-4">
              <label for="mobile" className="block text-[#ababab] text-md font-medium mb-1">
                First Name
              </label>
              <div className="flex items-center bg-white border border-gray-600 rounded-lg">
                <input
                  id="mobile"
                  type="text"
                  className="w-full p-2.5 text-sm  text-[#1c1c1c] rounded-lg focus:outline-none focus:ring-0 focus:ring-white"
                />
              </div>
            </div>
            ...
            <div className="mt-4">
              <label className="block text-[#ababab] text-md font-medium mb-1">Date of Birth</label>
              <div className="flex gap-2">
                <select className="w-1/3 px-3 py-2 text-sm  text-[#1c1c1c]   rounded focus:outline-none  border-0">
                  <option>Day</option>
                </select>
                <select className="w-1/3 px-3 py-2 text-sm  text-[#1c1c1c]    rounded focus:outline-none  border-0">
                  <option>Month</option>
            ...
            <div className="relative mb-2 mt-5">
              <div className="flex space-x-4 rtl:space-x-reverse">
                <label className="checkboxLabel flex items-center justify-center space-x-4 rtl:space-x-reverse text-sm font-semibold mb-2">
                  <input type="checkbox" name="terms_accepted" className="w-3 h-3 rounded-sm focus:ring-0" value="false" />
                  <span className="checkboxLabel text-[#ababab] text-lg font-light">
                    I am 18 years or older and accept the{" "}
                    <a
                      className="text-yellow-500 cursor-pointer underline dark:text-modalSecondaryTextColorDark text-modalSecondaryTextColorLight"
                    ...
                    -{" "}
                    <a
                      className="text-yellow-500 c   ursor-pointer underline dark:text-modalSecondaryTextColorDark text-modalSecondaryTextColorLight"
                      href="/privacy-policy"
                    >
                      Privacy Policy
                    </a>
            ...
            <div className="relative mb-2">
              <div className="flex space-x-4 rtl:space-x-reverse">
                <label className="checkboxLabel flex items-center justify-center space-x-4 rtl:space-x-reverse text-sm font-semibold mb-2">
                  <input type="checkbox" name="terms_accepted" className="w-3 h-3 rounded-sm focus:ring-0 border-none" value="false" />
                  <span className="checkboxLabel text-[#ababab] text-lg font-light">I agree to receive bonus & marketing emails.</span>
                </label>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center mx-7 mt-5">
              <hr className="w-3/4  border-yellow-500" />
              <div className="flex items-center font-extrabold justify-center space-x-2 rtl:space-x-reverse p-7 text-sm">
                <span>Already have an account?</span>
                <span className="cursor-pointer dark:text-modalSecondaryTextColorDark text-modalSecondaryTextColorLight text-yellow-500">Login</span>
              </div>
            </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-5 rounded shadow-lg max-w-xs w-full">
            ...
            <button onClick={closeModal} className="mt-4 bg-yellow-500 text-black py-2 px-4 rounded w-full hover:bg-yellow-600">
              Close
            </button>
          </div>
        </div>
