import { SPORTBOOK_BASE_URL } from "../../../helpers/constants";
...
export const cmsSportbook = {
  ...
  startSportbook: function (
    ...
    if (defaultPage != "" && defaultPage != undefined)
