    ...
    <header className="bg-[#2E2E2E]text-white shadow-lg">
      <div className="flex items-center justify-between py-3 px-4">
        ...
        <Link to="/home" className="flex items-center space-x-4" onClick={() => setActiveItem("home")}>
          ...
          <h1 className="text-[30px] font-bold text-primary-yellow">CASHBET</h1>
        </Link>
          ...
          {user ? (
            <>
              ...
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <span className="pl-3 pt-1.5 absolute">
                    <i class="fa-solid fa-money-bill"></i>
                  </span>
                  <MenuButton className="pl-9 relative inline-flex w-28 justify-center gap-x-1.5 rounded-md text-white px-3 py-2 text-sm font-semibold text-gray-900 border border-gray-300 hover:text-yellow-500 hover:border-yellow-500">
                    {user?.role || "User"}
