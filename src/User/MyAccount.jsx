            ...
            <div className="bg-gray-900 flex flex-grow">
                ...
                <div className="w-64 bg-[#1c1c1c]  ">
                    ...
                    <li className="ml-4 py-2 mr-2 mt-2 rounded-lg bg-yellow-500 text-black font-semibold flex items-center gap-2">
                            ...
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight ">My Account</span>
                        </li>
                        <li className="mt-0.5 py-2 ml-3 mr-2 rounded-lg text-white hover:text-black hover:bg-yellow-500 cursor-pointer flex items-center gap-2">
                            <i className="ml-4 fa fa-dice text-white-500 hover:text-black text-xl"></i>
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight ">Casino Bets</span>
                        </li>
                        <li className="mt-0.5 px-2 py-2 ml-3 mr-2 rounded-lg text-white hover:text-black hover:bg-yellow-500 cursor-pointer flex items-center gap-2">
                            ...
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight "> Sports Bets</span>
                        </li>
                        <li className="mt-0.5 px-2 py-2 ml-3 mr-2 rounded-lg text-white hover:text-black hover:bg-yellow-500 hover:text-black cursor-pointer flex items-center gap-2">
                            ...
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight ">Transactions History</span>
                        </li>
                        <li className="mt-0.5 px-2 py-2 ml-3 mr-2 rounded-lg text-white hover:text-black hover:bg-yellow-500 cursor-pointer flex items-center gap-2">
                            <i className=" ml-4 fa fa-check-circle text-white-500 hover:text-black text-xl" ></i>
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight "> Verify Account</span>
                        </li>
                        ...
                        <li className=" mt-0.5px-2 py-2 ml-3 mr-2 rounded-lg text-white hover:text-black mt-auto hover:bg-yellow-500 cursor-pointer flex items-center gap-2">
                            ...
                            <span className="font-semibold dark:group-hover:text-profileModalSelectedItemColorDark text-left rtl:text-right group-hover:text-profileModalSelectedItemColorLight ">Logout</span>
                        </li>
                    </ul>
                </div>
