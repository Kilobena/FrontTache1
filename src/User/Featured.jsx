...
const Featured = ({ limit = null, hideFooter = false }) => {
  ...
  return (
    <>
      ...
      <section className="bg-[#242424] text-white min-h-screen mt-2">
        <div className="bg-[#3C3C3C] max-w-screen-xl p-4 mx-auto rounded-lg container mx-auto px-4 py-6">
          ...
          <div className="flex flex-wrap items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-4 mt-2">
              {/* Provider Filter */}
              <select
                  className="bg-white text-black px-4 py-2 rounded border border-gray-400 shadow-sm focus:ring-2 focus:ring-yellow-500 appearance-none pr-10 relative">
          ...
          {/* Games Grid */}
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-8 xl:grid-cols-8 gap-3">
  {displayedGames.map((game) => (
    <div
      ...
      style={{ width: "142px", height: "142px" }} // Set both width and height of container
    >
      <img
